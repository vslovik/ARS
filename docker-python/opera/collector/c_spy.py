...
class CommunitySpy(object):
    ...
    def spy(self):
        ...
        for level in communities:
            ...
            for nodes in communities[level]:
                ...
                CommunitySpy.write_partition(nodes, filename)
                count += 1
    ...
    @staticmethod
    def write_partition(nodes, filename=''):
        tags = dict()
        d = CommunitySpy.read_dict(CommunitySpy.get_data_dir() + CommunitySpy.SINGER_DICT)
