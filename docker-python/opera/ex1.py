...
def chess_pgn_graph(datafile = "/vagrant/data/singer_event.csv"):
    """Read opera events from file.

    Return the MultiDiGraph of singers connected by opera performance.
    Edges contain performance data in a dict.
